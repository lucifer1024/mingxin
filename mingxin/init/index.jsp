...
<link rel='shortcut icon'
	href='${rc.getContextPath()}/images/favicon.ico?2017/1/9 17:43:51' />
<link rel='stylesheet'
...
<body>
	<form method="post" action="CommunityHome.aspx" id="mainForm">
		...
		<%-- <div class="aspNetHidden">
			...
			<input type="hidden" name="eventArgument" id="eventArgument"
				value="" /> <input type="hidden" name="viewstate"
				id="viewstate"
				value="" />
		</div>
...
//]]>
		...
		<div id="top">
			<div class="wauto m0 cf pr">
				...
				<span id="MainContent_Header_spnLoggedIn">
					<ul class="fr">
						<li class="toDrop"><span class="fl">欢迎您， <i>lucifer1024
									(注册未激活) </i></span><span class="icon switch mt3 fl"></span>
							<ul id="MainContent_Header_ulMyAccountInfo" class="dropMenu hide">

								<li id="MainContent_Header_liChangePassword"
									onclick="window.location.href='/Account/ChangePassword.aspx';return false;">修改密码</li>
						...
						<li id="MainContent_Header_liSignout4RegisterUser"><a
							...
							href="javascript:__doPostBack('ctl00$ctl00$ctl00$MainContent$Header$lbSignOut','')">注销</a>
						</li>
						<li class="space"></li>
					</ul>
				</span>
		...
		<div class="mainBg">
			...
			<div class="mainNav w1000 m0"
				...
				<ul class="navList">
					<li class="now"><a href="/Room/CommunityHome.aspx">社区首页</a></li>
					<li style="display: none;"><a href="/Room/TopVisitRooms.aspx">人气榜单</a></li>
			...
			<div class="mainBox w1000 m0">
				...
				<div class="mainMid fl cf pr">
					...
					<div class="total">
						...
						<p class="cf">
							<i class="icon tuser fl"></i><span class="fl pl5"> 6640
								人在线</span>
						</p>
					</div>
									...
									<ul class="roomList cf cb" id="ulRoomList">
										...
										<li>
											...
											<div class="roomThumb" style="cursor: pointer"
												onclick="OpenRoom('${rc.getContextPath()}/Room/RoomDetail?RoomId=100002');return false;">
												<h1>石油帝国</h1>
												<img
												...
												<div class="cover"></div>
												<span class="id">ID:100002</span> <span class="num">3253/50000</span>
											</div>
										...
										<li>
											...
											<div class="roomThumb" style="cursor: pointer"
												...
												<div class="cover"></div>
												<span class="id">ID:100003</span> <span class="num">3378/50000</span>
											</div>
...
.rs_list li {
	...
	color: #666;
	list-style: none;
	background: url(${ rc.getContextPath ()
}
	...
	text-decoration: none;
					...
					<div class="right fl cf">
						<div class="rightside">
							<div class="rs_tit">
								<h3>蚂蚁快迅</h3>
								<a href="/Content/CommunityNonFarmList.aspx">更多+</a>
							</div>
							<div class="rs_list">
								...
								<ul>
									...
									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=388'>赢油天下2017-01-09评论</a>
									</li>

									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=387'>石油帝国2017-01-09评论</a>
									</li>

									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=386'>赢油天下2017-01-06评论</a>
									</li>

									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=385'>石油帝国2017-01-06评论</a>
									</li>

									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=384'>赢油天下2017-01-05评论</a>
									</li>

									<li><a
										href='/Content/CommunityNonFarmDetail.aspx?CommunityNonFarmId=383'>石油帝国2017-01-05评论</a>
									</li>
							...
							<div class="rs_tit">
								<h3>投资学堂</h3>
								<a href="/Content/CommunityInvestmentSchoolList.aspx">更多+</a>
							</div>
							<div class="rs_list">
								...
								<ul>
									...
									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=47'>交
											易 系 统 中 的 漏 洞...</a></li>

									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=46'>被套后对自己默念六句话</a>
									</li>

									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=45'>如何检验投资者的交易动力</a>
									</li>

									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=44'>成功的交易心理来源于勇...</a>
									</li>

									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=40'>只有彻底才能成功</a>
									</li>

									<li><a
										href='/Content/CommunityInvestmentSchoolDetail.aspx?CommunityInvestmentSchoolId=39'>只有彻底才能成功</a>
									</li>
							...
							<div class="rs_tit">
								<h3>社区公告</h3>
								<a href="/Content/CommunityAnnouncementList.aspx">更多+</a>
							</div>
							<div class="rs_list">
								...
								<ul>
									...
									<li><a
										href='/Content/CommunityAnnouncementDetail.aspx?AnnouncementId=10'>银蚂蚁在线喊单社区为何...</a>
									</li>

									<li><a
										href='/Content/CommunityAnnouncementDetail.aspx?AnnouncementId=8'>银蚂蚁在线喊单社区重磅...</a>
									</li>

									<li><a
										href='/Content/CommunityAnnouncementDetail.aspx?AnnouncementId=9'>银蚂蚁在线喊单社区致投...</a>
									</li>
		...
		<a href="javascript://" style="display: none"><img border="0"
			src="${rc.getContextPath()}/images/MobileQRCode.jpg"
			alt="扫一扫，下载手机喊单软件" title="扫一扫，下载手机喊单软件" class="MobileQRCode"
			id="imgMobileQRCode"></a>
